...
1. **立即解决 - 降低检测敏感度**
   ```json
   {
     "echo_threshold": 0.5,          // 从0.6降到0.5
     "min_suppression": 0.4,         // 从0.3增加到0.4
     "echo_suppression_factor": 0.6  // 从0.7降到0.6
   }
   ```
...
**参数说明:**
- `echo_threshold`: 0.3-0.8，越低越宽松
- `min_suppression`: 0.2-0.5，越高越保守
- `echo_suppression_factor`: 0.4-0.8，越低抑制越轻
